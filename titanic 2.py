...
def convert_Dataframe(df):
    df= df.drop([ 'Fare', 'Name','Ticket', 'Cabin'], axis=1)
...
#model= xg_reg = xgb.XGBRegressor(objective ='reg:logistic', colsample_bytree = 0.3, 
...
x_predict= test_set[['Parch', 'PassengerId']]
